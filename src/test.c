...
#define TEST_X25519 0
#define TEST_HMAC_SHA256 1
...
//SHA2 tests ==============================================================>
#if defined(TEST_SHA2) && (TEST_SHA2 == 1)
...
//base64 tests ==============================================================>
#if defined(TEST_BASE64) && (TEST_BASE64 == 1)
...
// X25519 test =================================================================>
#if defined(TEST_X25519) && (TEST_X25519 == 1)
	printf("X25519 TEST -->\n");
...
// HMAC SHA256 test =================================================================>
#if defined(TEST_HMAC_SHA256) && (TEST_HMAC_SHA256 == 1)
//	uint8_t hmacKey[32] = {
//			0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
//			0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18,
//			0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28,
//			0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38};
	uint8_t hmacKey[7] = {0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x69};
	uint8_t hmacMessage[8] = {
				'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h'};
	hamacSha256Calc(hmacKey, 7, hmacMessage, 8);
	hamacSha512Calc(hmacKey, 7, hmacMessage, 8);
#endif
// END HMAC SHA256 test =================================================================>
	(void)buff;
	(void)rfc7748_alice_sec;
	(void)rfc7748_bob_sec;
	return EXIT_SUCCESS;
}
